...
|---|---|---|---|
| 0:00 to 0:12 | The problem | Landing page. The supply map draws: SPYx, 30.35% of supply in programs; AAPLx 1.87%. | Tokenized stocks are composable. They sit in Raydium pools and Kamino reserves. Shareholder records are not. A wallet scan at a record date misses everything a program holds. |
